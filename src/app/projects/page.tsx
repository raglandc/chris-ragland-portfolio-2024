                    ...
                    <div>
                        <div className="mx-auto max-w-7xl px-4 md:px-6">
                            ...
                            <p className="mt-1 block text-custom-textSecondary lg:text-lg">
                                Take a look at some of the awesome projects I
                                worked on during my senior year at USF
                            </p>
                        </div>
                ...
                <div className="space-y-16">
                    <div>
                        <div className="mx-auto max-w-7xl px-4 md:px-6">
                            ...
                            <p className="mt-1 block text-custom-textSecondary lg:text-lg">
                                Here are some of the interesting projects I have
                                worked on during my junior year at USF
                            </p>
                        </div>
                ...
                <div className="space-y-16">
                    <div>
                        <div className="mx-auto max-w-7xl px-4 md:px-6">
                            ...
                            <p className="mt-1 block text-custom-textSecondary lg:text-lg">
                                While working full time, these are some of the
                                resulting projects that I worked on.
                            </p>
                        </div>
